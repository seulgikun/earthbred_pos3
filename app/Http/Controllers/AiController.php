        ...
        foreach ($modelsToTry as $model) {
            ...
            try {
                ...
                if ($response->successful()) {
                    ...
                    $disclaimer = "\n\n---\n⚠️ **Disclaimer:** This response is generated by an AI and may not always be accurate. Please verify important information with your store manager or staff before making business decisions.";
                    return response()->json([
                        'success' => true,
